...
public class GradeDistributionTest {
    ...
    private void testaa(int[] luvut, int[] jakauma, double pros) {
        ...
        assertFalse("ensure that you printGradeDistribution a line with the text  \"Acceptance percentage:\"", rivi == null);
        for (int i = 0; i < 6; i++) {
    ...
    private void testaaTuloste(int[] luvut) {
        ...
        assertFalse("ensure that you printGradeDistribution a line with the text  \"Grade distribution:\"", rivi == null);
        rivi = haeRivi(rivit, "centage");
        assertFalse("ensure that you printGradeDistribution a line with the text  \"Acceptance percentage:\"", rivi == null);
        for (int i = 0; i < 6; i++) {
            rivi = haeRivi(rivit, i + ":");
            assertFalse("ensure that you printGradeDistribution a line with the text  \"" + i + ":\"", rivi == null);
        }
    }
